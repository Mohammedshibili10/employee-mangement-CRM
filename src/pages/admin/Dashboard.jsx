    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          ...
          {distribution.map((d) => (
            <div key={d.name} className="flex justify-between text-sm py-1 text-slate-600">
              <span>{d.name}</span>
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <h3 className="font-semibold text-slate-800 mb-3">Attendance Summary</h3>
          ...
          <div className="flex justify-between text-sm py-1 text-slate-600">
            <span>Late</span>
            <span className="font-medium text-amber-600">{attendance.late}</span>
          </div>
          <div className="flex justify-between text-sm py-1 text-slate-600">
            <span>Absent</span>
            <span className="font-medium text-rose-600">{attendance.absent}</span>
          </div>
        </div>

        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <h3 className="font-semibold text-slate-800 mb-3">Leave Overview</h3>
          <div className="flex justify-between text-sm py-1 text-slate-600">
            <span>Pending</span>
            <span className="font-medium text-amber-600">{pendingLeaves}</span>
          </div>
          <div className="flex justify-between text-sm py-1 text-slate-600">
            <span>Approved</span>
          ...
          <div className="flex justify-between text-sm py-1 text-slate-600">
            <span>Rejected</span>
            <span className="font-medium text-rose-600">{rejectedLeaves}</span>
          </div>
        </div>
      </div>
