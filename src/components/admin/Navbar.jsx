  ...
  return (
    <header className="sticky top-0 z-30 h-16 glass border-b border-slate-200/70 flex items-center justify-between px-4 sm:px-6">
      <div className="flex items-center gap-3">
        ...
        <h1 className="text-base sm:text-lg font-bold tracking-tight text-slate-800">Admin Dashboard</h1>
      </div>
      ...
      <div className="relative">
        ...
        {open && (
          <>
            ...
            <div className="absolute right-0 mt-2 w-60 max-w-[calc(100vw-1.5rem)] bg-white rounded-2xl shadow-premium ring-1 ring-slate-900/5 z-20 overflow-hidden animate-scale-in origin-top-right">
